...
class extractor():
    ...
    def extract_table(self,path:str,page_nums:list[int]=None) -> list[list[pd.DataFrame],list[int]]:
        """
...
"""
NOTE 
FOR TABLES THE X AXIS IS THE ROWS AND THE Y AXIS IS THE COLUMNS!!! (array[x][y])

main without all the bloat.
and extraction algorithm for wnt
"""
