import whiteSpace.FindBezoldiging as FindBezoldiging
...
__all__ = ["FindBezoldiging","nameFind","scannedConvert","whitespaceMain","exactmatch_whitespace"]  #allows to import all methods with *