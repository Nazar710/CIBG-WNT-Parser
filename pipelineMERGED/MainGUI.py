...
from MainProgram import WNTPageIdentifier
...
class PDFProcessorApp:
    ...
    def create_image_label(self):
        image = tk.PhotoImage(file="images\image333.png")
    ...
    def create_loading_window(self):
        ...
        # Use the WNTPageIdentifier to process the selected PDF files
        wnt_identifier = WNTPageIdentifier()
        wnt_info_list = []

        for pdf_file in self.selected_pdf_files:
            wnt_pages = wnt_identifier._WNTPageIdentifier__identify_wnt_pages(pdf_file)
        ...
        output_csv_path = os.path.join(path, f"{file_name}.csv")
        
        process_pdfs(wnt_info_df, path, output_csv_path)
        ...
        # Print the list of selected PDF files and the processed information
        print("Selected PDF files:", self.selected_pdf_files)
        print("Processed WNT information:", wnt_info_df)
