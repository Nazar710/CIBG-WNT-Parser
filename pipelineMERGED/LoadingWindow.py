...
class LoadingWindow(tk.Toplevel):
    def __init__(self, parent, file_name, path, selected_files):
        ...
        self.title("COMPLETE Processed WNT information")
        ...
        selected_files_label = tk.Label(self, text="COMPLETE Processed WNT information:", font=("Arial", 10))
        selected_files_label.pack(pady=5)
        for file_path in selected_files:
            file_label = tk.Label(self, text=file_path, font=("Arial", 10))
            file_label.pack()

        loading_label = tk.Label(self, text=f"Generated {self.file_name} in {self.path}...", font=("Arial", 10))
